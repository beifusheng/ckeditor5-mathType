...
You can create an issue on https://github.com/ckeditor/ckeditor5/issues including the build id - `ytuu60xc6w26-iklqp5kb3w2j`. Make sure that the question / problem is unique, please look for a possibly asked questions in the search box. Duplicates will be closed.
...
=======
# ckeditor5-mathType
ckeditor5配置私库，增加公式及化学式
>>>>>>> 94cd4ddd577fd314589ab4147259f7bcc2b63199
